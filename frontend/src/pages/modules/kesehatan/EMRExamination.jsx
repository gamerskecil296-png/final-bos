...
export default function EMRExamination() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/app/kesehatan/bookings'); // Kembali ke antrean
    } catch (err) {
  ...
  if (!bookingId || !patientId || bookingId === 'undefined' || patientId === 'undefined') {
    return (
      <PageContent>
        <DashboardHero
          title="Pemeriksaan Medis EMR"
          highlightedTitle="Online"
          subtitle="Modul pemeriksaan fisik dan rekam medis elektronik khusus antrean dari aplikasi."
          icon="monitor_heart"
        />
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-black text-[var(--theme-text)] flex items-center gap-2">
            ...
            Pemeriksaan Medis EMR (Online)
          </h1>
          <p className="text-xs font-bold text-[var(--theme-text-muted)] uppercase tracking-widest">Sesi EMR Sedang Berlangsung</p>
        </div>
      </div>
