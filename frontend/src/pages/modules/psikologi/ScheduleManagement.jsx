...
export default function ScheduleManagement() {
  ...
  const canViewSchedules = hasPermission('psychologist.schedules.view');
  const canCreateSchedules = hasPermission('psychologist.schedules.create');
  const canUpdateSchedules = hasPermission('psychologist.schedules.update');
  const canDeleteSchedules = hasPermission('psychologist.schedules.delete');
  const canManageSchedules = canCreateSchedules || canUpdateSchedules || canDeleteSchedules;
  ...
  return (
    <PageContent>
      <DashboardHero 
        ...
        actions={hasUnsavedChanges && canManageSchedules ? (
