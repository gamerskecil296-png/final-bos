...
func SetupSuperAdminRoutes(r fiber.Router) {
	...
	users.Post("/", middleware.RequireAnyPermission("rbac.users.create", "psychologist.core.create", "health.core.create"), controllers.CreateUser)
	...
	psych.Put("/:id", m("psychologist.core.update"), controllers.UpdatePsychologist)
	psych.Delete("/:id", m("psychologist.core.delete"), controllers.DeletePsychologist)
	...
	tk.Put("/:id", m("health.core.update"), controllers.UpdateTenagaKesehatan)
	tk.Delete("/:id", m("health.core.delete"), controllers.DeleteTenagaKesehatan)
